...
public class AddView extends JFrame {
	...
	public void init() {
		...
		welcome = new JLabel("VẬT LIỆU");
		idVatLieu = new JLabel("ID Vật Liệu");
		idVatLieuB = new JTextField();
		tenVatLieu = new JLabel("Tên Vật Liệu");
		tenVatLieuB = new JTextField();
		giaBan = new JLabel("Giá Bán");
		giaBanB = new JTextField();
		donViTinh = new JLabel("Đơn Vị Tính");
		donViTinhB = new JTextField();
		giaMua = new JLabel("Giá Mua");
		giaMuaB = new JTextField();
		tonKho = new JLabel("Tồn Kho");
		tonKhoB = new JTextField();
		viTriTrongKho = new JLabel("Vị Trí Trong Kho");
		viTriTrongKhoB = new JTextField();
		...
		donViTinhB.setBounds(600, 223, 200, 40);
		giaMuaB.setBounds(200, 373, 200, 40);
		idVatLieuB.setBounds(200, 173, 200, 40);
		tonKhoB.setBounds(600, 373, 200, 40);
		...
		this.add(tonKho);
		this.add(giaMua);
		this.add(viTriTrongKho);

		this.add(idVatLieuB);
		this.add(tenVatLieuB);
		this.add(giaBanB);
		this.add(donViTinhB);
		this.add(viTriTrongKhoB);
		this.add(tonKhoB);
		this.add(giaMuaB);
	}
...
//			vlxdDAO.Save(vatLieuJSON.toString());
			client.sendData(vatLieuJSON);
			System.out.println(vatLieuJSON);
		} catch (Exception e) {
